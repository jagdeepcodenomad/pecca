...
<div class="mi">
	...
	<div class="ad_hd fright">
		...
		?>
		<form id="frmsubm" name="frmsubm" onsubmit="return validate_user()" action="<?php httpIndex() ?>admin/edit_user/<?php echo $user_details['user_id'] ?>" method="post">
			<div class="sngl_row">
				<div class="col-6 hf_sec_l">
					...
					<div class="fld_o_a">
						<input id="full-name" value="<?php echo $user_details['full_name'] ?>" name="full_name" type="text"/>
					</div>
				</div>
				<div class="col-6 hf_sec_r">
					...
					<div class="fld_o_a">
						<input id="username" value="<?php echo $user_details['username'] ?>" name="username" type="text"/>
					</div>
				</div>
			</div>
			...
			<div class="sngl_row">
				...
				<div class="col-6 hf_sec_r">
					...
					<div class="fld_o_a">
						<input value="<?php echo $user_details['phone'] ?>" id="phone" name="phone" type="text"/>
					</div>
				</div>
			</div>
